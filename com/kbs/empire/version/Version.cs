...
//
////////////////////////////////////////////////////////////////////////////////////////
namespace com.kbs.empire.version
{
    public class Version
    {
        public const string VERSION = "8";//01/24/2017 - Added Nuke Percentage to the queryI 
        //"7";//01/07/2017 - Added Switched Supply/Drain Tags
        //"6";//11/19/2017 - Repaired Save Error in random gen
        //"5"; //10/29/17 - Added Loop Protection Class, Get Terrain Info call
        //"4"; //10/13/17
        //"3"; //10/02/17
        //"2"; //09/17/17
        //"1"; //09-09-17
